...
import { ChevronLeft, ChevronRight, MapPin, Mic, FolderInput, Sparkles, Files } from "lucide-react";
...
const CaseStudy = () => {
  ...
  return (
    <section id="case-studies" className="py-24 md:py-32 bg-foreground text-background overflow-hidden">
        ...
        <div className="mb-12 pb-10 border-b border-background/15">
          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              <h1 className="text-4xl md:text-5xl font-serif leading-[1.05] mb-4">
                Recent case studies.
              </h1>
