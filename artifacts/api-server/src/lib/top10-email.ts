...
3. COMMENTARY for EVERY item — 2-3 sentences each. Lead with the publisher and a paraphrased action verb describing what shipped, bolded with markdown asterisks. Then 1-2 sentences interpreting the news through ONE analytical LENS. Vary the lens across items — that's what makes the dispatch feel authored instead of generated.
   ...
   - **Tier 3 (academic papers / preprints)**: Default to 2 sentences. Name a specific applied audience (clinicians, robotics labs, optimization researchers working on X) — never general "AI practitioners". If the paper isn't groundbreaking, prefer observational reporting over speculation about industry impact. Do NOT give a research preprint the same editorial weight as a Microsoft or OpenAI item — that flattening is the single biggest "machine-curated" tell.
   ...
   PAPER ITEMS — short, applied, specific. Never an autogenerated-abstract paraphrase.
